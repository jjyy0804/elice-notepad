      ...
      <div className='flex  items-center p-9 w-full'>
        <div className='flex items-center w-full justify-center relative'>
          ...
          <div className='flex jutify-end gap-2 absolute right-0 mr-10'>
            <button className='w-auto bg-indigo-500 text-white p-2 rounded-md hover:bg-blue-600 flex-shrink-0'>추가</button>
            <button className='w-auto bg-indigo-500 text-white p-2 rounded-md hover:bg-blue-600 flex-shrink-0'>커버 변경</button>
          </div>
        </div>
      </div>
